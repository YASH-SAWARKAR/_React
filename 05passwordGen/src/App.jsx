...
function App() {
  ...
  return (
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-purple-400 text-purple-1000">
      <h1 className="text-white text-center font-bold">Password Generator</h1>
      <div className="flex shadow rounded-lg overflow-hidden mb-4">
        <input
          type="text"
          value={password}
          className="bg-white outline-none w-full py-1 px-3 background-color-white"
